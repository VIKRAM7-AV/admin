...
const CourseInformation: FC<Props> = ({
  ...
  useEffect(() => {
    if (data?.layout?.categories) {
      ...
      if (!courseInfo.categories && data.layout.categories.length > 0) {
        setCourseInfo({
          ...courseInfo,
          categories: data.layout.categories[0].title, // Default to the first category
        });
      }
    }
  }, [data, courseInfo, setCourseInfo]);
